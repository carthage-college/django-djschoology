...
# python
sys.path.append('/data2/python_venv/3.6/djschoology/lib/python3.6/')
sys.path.append('/data2/python_venv/3.6/djschoology/lib/python3.6/site-packages/')
# django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'djschoology.settings.production')
